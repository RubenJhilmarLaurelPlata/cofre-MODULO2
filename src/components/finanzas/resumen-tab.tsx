...
const CLASIFICACION_BADGE: Record<string, string> = {
  ENTREGA_NORMAL: 'bg-emerald-50 text-emerald-700 border-emerald-200 dark:bg-emerald-500/10 dark:text-emerald-400 dark:border-emerald-800',
  ENTREGA_EXCEPCIONAL: 'bg-amber-50 text-amber-700 border-amber-200 dark:bg-amber-500/10 dark:text-amber-400 dark:border-amber-800',
  ENTREGA_IMPORTACION: 'bg-blue-50 text-blue-700 border-blue-200 dark:bg-blue-500/10 dark:text-blue-400 dark:border-blue-800',
  ANTICIPO: 'bg-purple-50 text-purple-700 border-purple-200 dark:bg-purple-500/10 dark:text-purple-400 dark:border-purple-800',
  AJUSTE: 'bg-gray-50 text-gray-700 border-gray-200 dark:bg-gray-500/10 dark:text-gray-400 dark:border-gray-700',
};
                        ...
                        {pagos.map((p) => (
                          <tr key={p.id}>
                            ...
                            <td className="whitespace-nowrap px-3 py-2">
                              <span className={`rounded-full border px-2 py-0.5 text-xs font-medium ${CLASIFICACION_BADGE[p.clasificacion] ?? ''}`}>
                                {p.clasificacionLabel}
                              </span>
                            </td>
